...
public class MQTTClient {
	...
	public MQTTClient(String serverUrl, String caFilePath, String clientCrtFilePath, String clientKeyFilePath, String mqttUserName, String mqttPassword, String clientId) {
		try {
	...
	public static PEMKeyPair convertPrivateKeyFromPKCS8ToPKCS1(PrivateKeyInfo privateKeyInfo) throws Exception {
