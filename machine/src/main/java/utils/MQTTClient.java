...
public class MQTTClient {
	...
	public MQTTClient(String serverUrl, String caFilePath, String clientCrtFilePath, String clientKeyFilePath,
			String mqttUserName, String mqttPassword, String clientId) {
		try {
